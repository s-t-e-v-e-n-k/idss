...
class IDSS:
    def __init__(self):
        ...
        self.i.add_watch(str(maildir / ".Spam" / "cur"), mask=MASK)
    ...
    def process_events(self):
        for event in self.i.event_gen(yield_nones=False):
            ...
            logging.debug("Calling {event_map[event_type]} for {filename}")
            getattr(self, event_map[event_type])(filename)
    ...
    def delete_event(self, filename):
        ...
        #logging.debug(f"Unhandled EVENT={event_type}, FILENAME={filename}")
